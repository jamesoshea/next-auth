(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('url'), require('http'), require('https'), require('zlib'), require('stream'), require('buffer'), require('string_decoder'), require('util')) :
	typeof define === 'function' && define.amd ? define(['exports', 'url', 'http', 'https', 'zlib', 'stream', 'buffer', 'string_decoder', 'util'], factory) :
	(global = global || self, factory(global['next-auth-client'] = {}, global.url, global.http, global.https, global.zlib, global.stream, global.buffer, global.string_decoder, global.util));
}(this, function (exports, url, http, https, zlib, stream, buffer, string_decoder, util) { 'use strict';
	...
	*/
	...
	var Buffer$3 = safer_1.Buffer; // Note: UTF16-LE (or UCS2) codec is Node.js native. See encodings/internal.js
	// == UTF16-BE codec. ==========================================================
	...
	var Buffer$4 = safer_1.Buffer; // UTF-7 codec, according to https://tools.ietf.org/html/rfc2152
	...
	var Buffer$5 = safer_1.Buffer; // Single-byte codec. Needs a 'chars' string parameter that contains 256 or 128 chars that
	...
	function SBCSCodec(codecOptions, iconv) {
	  ...
	  this.decodeBuf = Buffer$5.from(codecOptions.chars, 'ucs2'); // Encoding buffer.
	...
	var Buffer$6 = safer_1.Buffer; // Multibyte codec. In this scheme, a character is represented by 1 or more bytes.
	...
	function DBCSDecoder(options, codec) {
	  // Decoder state
	  this.nodeIdx = 0;
	  this.prevBuf = Buffer$6.alloc(0); // Static data
	...
	var encodings = createCommonjsModule(function (module, exports) {
	  ...
	  var modules = [internal, utf16, utf7, sbcsCodec, sbcsData, sbcsDataGenerated, dbcsCodec, dbcsData]; // Put all encoding/alias/codec definitions to single object and export it. 
	...
	var Buffer$7 = buffer.Buffer,
	    Transform = stream.Transform; // == Exports ==================================================================
	...
	var Buffer$8 = buffer.Buffer; // Note: not polyfilled with safer-buffer on a purpose, as overrides Buffer
	...
	var extendNode = function (iconv) {
	  ...
	  iconv.extendNodeEncodings = function extendNodeEncodings() {
	    ...
	    SlowBuffer.prototype.toString = function (encoding, start, end) {
	      ...
	      if (Buffer$8.isNativeEncoding(encoding)) return original.SlowBufferToString.call(this, encoding, start, end); // Otherwise, use our decoding method.
	    ...
	    Buffer$8.byteLength = SlowBuffer.byteLength = function (str, encoding) {
	      ...
	      if (Buffer$8.isNativeEncoding(encoding)) return original.BufferByteLength.call(this, str, encoding); // Slow, I know, but we don't have a better way yet.
	    ...
	    Buffer$8.prototype.toString = function (encoding, start, end) {
	      ...
	      if (Buffer$8.isNativeEncoding(encoding)) return original.BufferToString.call(this, encoding, start, end); // Otherwise, use our decoding method.
	...
	Body.prototype._convert = function (encoding) {
	  ...
	  return convert$1(Buffer.concat(this._raw), encoding, charset);
	};
	/**
	...
	var nodeFetch = createCommonjsModule(function (module) {
	   ...
	   */
	  var parse_url = url.parse;
	  var resolve_url = url.resolve; // commonjs
	    ...
	    return new Fetch.Promise(function (resolve, reject) {
	      ...
	      if (!headers$1.has('content-length') && /post|put|patch|delete/i.test(options.method)) {
	        if (typeof options.body === 'string') {
	          headers$1.set('content-length', Buffer.byteLength(options.body)); // detect form data input from form-data module, this hack avoid the need to add content-length header manually
	        } else if (options.body && typeof options.body.getLengthSync === 'function') {
	          // for form-data 1.x
	          if (options.body._lengthRetrievers && options.body._lengthRetrievers.length == 0) {
	            headers$1.set('content-length', options.body.getLengthSync().toString()); // for form-data 2.x
	      ...
	      options.headers = headers$1.raw(); // http.request only support string as host header, this hack make custom host header possible
	      ...
	      req.on('response', function (res) {
	        ...
	        var name = headers$1.get('content-encoding'); // for gzip
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 9:
	                return _context.abrupt("return", fetchNpmNode('/auth/session', {
	        ...
	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                return _context2.abrupt("return", fetchNpmNode('/auth/csrf', {
	                  credentials: 'same-origin'
	                }).then(function (response) {
	        ...
	        return regeneratorRuntime.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              ...
	              case 3:
	                return _context3.abrupt("return", fetchNpmNode('/auth/linked', {
	                  credentials: 'same-origin'
	                }).then(function (response) {
	        ...
	        return regeneratorRuntime.wrap(function _callee4$(_context4) {
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              ...
	              case 3:
	                return _context4.abrupt("return", fetchNpmNode('/auth/providers', {
	                  credentials: 'same-origin'
	                }).then(function (response) {
	          ...
	          while (1) {
	            switch (_context6.prev = _context6.next) {
	              ...
	              case 4:
	                ...
	                return _context6.abrupt("return", fetchNpmNode(route, {
	                  method: 'POST',
	                  headers: {
	            ...
	            switch (_context7.prev = _context7.next) {
	              ...
	              case 2:
	                ...
	                encodedForm = Object.keys(formData).map(function (key) {
	                  ...
	                  return encodeURIComponent(key) + '=' + encodeURIComponent(formData[key]);
	                }.bind(this)).join('&'); // Remove cached session data

	                this._removeLocalStore('session');

	                return _context7.abrupt("return", fetchNpmNode('/auth/signout', {
	                  method: 'POST',
	                  headers: {
	                    'Content-Type': 'application/x-www-form-urlencoded'
	                  },
